...
- [ ] Update `docs/language-reference.md` to link error codes for required fields
- [ ] Add error code references for:
...
- [ ] Ensure links point to `docs/errors.md` (requires WI-049 to be complete first)
- [ ] Review for consistency in documentation style
